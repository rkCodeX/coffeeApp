        ...
        <>
            ...
            <div className='w-[100%] h-auto bg-red-950 flex flex-col px-[3rem] py-[5rem]'>
                <div className='w-[100%] h-auto flex flex-row items-center justify-start'>
                    <div classNam='flex flex-col gap-[10rem] w-[40%] text-gray-100 h-auto'>
                        <h1 className='text-start font-bold text-3xl mb-[1rem]'>MILTON'S</h1>
                    ...
                    <div className='flex flex-col gap-[1rem] text-gray-100 w-[20%]'>
                        <h1 className='text-lg font-bol mb-[2rem]'>Page</h1>
                        <p>lorem</p>
                        <p>lorem</p>
                        <p>lorem</p>
                        <p>lorem</p>
                    </div>
                    <div className='flex flex-col gap-[1rem] text-gray-100 w-[20%]'></div>
                    <div></div>
                </div>
                <div></div>
            </div>
