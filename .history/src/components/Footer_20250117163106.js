    ...
    return(
        <>
            ...
            <div className='w-[100%] h-auto bg-red-950 flex flex-col px-[3rem] py-[5rem]'>
                <div className='w-[100%] h-auto flex flex-row gap-[2rem] items-center justify-start'>
                    <div className='flex flex-col gap-[1rem] w-[40%] text-justify text-gray-100 h-auto ml-[2rem]'>
