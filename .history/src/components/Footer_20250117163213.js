    ...
    return(
        <>
            ...
            <div className='w-[100%] h-auto bg-red-950 flex flex-col px-[3rem] py-[5rem]'>
                <div className='w-[100%] h-auto flex flex-row gap-[2.5rem] items-center justify-start'>
                    <div className='flex flex-col gap-[1rem] w-[45%] text-justify text-gray-100 h-auto'>
                        <h1 className='text-start font-bold text-3xl'>MILTON'S</h1>
                    ...
                    <div className='flex flex-col gap-[1rem] text-gray-100 w-[15%]'>
                    ...
                    <div className='flex flex-col gap-[1rem] text-gray-100 w-aut'>
