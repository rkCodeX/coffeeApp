...
function Footer(){
    return(
        <>
            ...
            <div className='w-[100%] h-auto bg-red-950 flex flex-col items-center justify-center gap-[3rem] p-[6rem]'>
                <div className='w-[100%] h-auto flex flex-row gap-[6rem] items-center justify-start'>
                    <div className='flex flex-col gap-[1.5rem] w-[50%] text-justify text-gray-100 h-auto'>
                        <h1 className='text-start font-bold text-4xl'>MILTON'S</h1>
                        <p>  text-gray-100 mollitia quasi sed, veniam odio quibusdam iusto, aut illo in ab quia nisi deserunt delectus doloremque sapiente beatae consequatur! Incidunt, sequi? Temporibus cumque hic sunt tempore in iure est, nisi nulla fugiat repellat culpa magnam, natus nemo rem quae eius labore. Pariatur, explicabo.</p>
                    </div>
                ...
                <div className='text-center w-[100%] border-t-2 border-gray-400'>hello</div>
            </div>
        </>
    );
}
