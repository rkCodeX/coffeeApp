...
function Footer(){
    return(
        <>
            <div className='flex flex-row items-center justify-center w-[100%] h-auto px-[2.5rem] pt-[4rem] bg-[#d5d5d5]'>
            ...
            <div className='w-[100%] h-auto bg-red-950 flex flex-col items-center justify-center gap-[3rem] p-[6rem]'>
                ...
                <div className='text-center w-[100%] border-t-2 border-gray-400 pt-[3rem]'>hello</div>
            </div>
        </>
    );
}
