...
function Footer(){
    return(
        <>
            <div className='flex flex-row items-center justify-center w-[100%] h-auto px-[2.5rem] py-[4rem] bg-[#d5d5d5]'>
                <div className='flex flex-col w-[50%] h-auto p-[3rem] gap-[4rem]'>
                    ...
                    <div className='flex flex-row w-full items-center justify-center h-[2.8rem] bg-red-950 rounded-md p-2'>
                        ...
                        <button className='text-[#35211e] bg-[#f8b878] font-bold px-2 py-1 rounded-md border-2 border-red-950'>SUBSCRIBE</button>
                    </div>
                </div>  
            ...
            <div className='w-[100%] h-auto bg-red-950 flex flex-col items-center justify-center gap-[3rem] px-[6rem] pt-[6rem]'>
                ...
                <div className='text-center w-[100%] border-t-2 border-red-900 text-gray-100 py-[2rem]'>All copyrights are reserved by YourCompanyName</div>
            </div>
        </>
    );
}
