...
function Footer(){
    return(
        <>
            ...
            <div className='w-[100%] h-auto bg-[#35211e] flex flex-col items-cente justify-center gap-[3rem] px-[6rem] pt-[6rem]'>
                <div className='w-[100%] h-auto flex flex-row max-[718px]:flex-col gap-[6rem] items-center justify-start'>
