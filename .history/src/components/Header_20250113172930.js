...
function Header(){
    return(
        <>
           <div className='bg-[#d5d5d5] w-full h-auto flex flex-col gap-[2re]'>
                ...
                <div className='flex flex-row w-full h-auto px-[4rem]'>
            
                    <div className='whitespace-pre text-[4rem]'>
                        IT'S BREAK <br /> WITH <b> COFFEE <br />            COFFEE <br/>            COFFEE </b><br />            COFFEE <br />            COFFEE <br />            COFFEE
                    </div>
