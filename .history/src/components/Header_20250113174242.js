        ...
        <>
           <div className='bg-[#d5d5d5] w-full h-auto flex flex-col gap-[2rem]'>
                ...
                <div className='flex flex-row w-full h-auto p-[5rem]'>
                    ...
                    <div className='flex-1 whitespace-pre text-[5.5rem] leading-none'>
                         IT'S BREAK <br />WITH <span className='font-extrabold' > COFFEE <br />           COFFEE <br/>           COFFEE </span><br /><span className='text-[6rem]'>          COFFEE <br />          COFFEE <br />          COFFEE</span>
                    </div>
