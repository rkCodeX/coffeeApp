           ...
           <div className='bg-[#d5d5d5] w-full h-auto flex flex-col gap-[2rem]'>
                <div className='flex flex-row justify-between items-center w-[full] px-[3rem]'>
                        ...
                        <div className='font-bold text-gray-800 flex flex-row justify-between items-center gap-[2rem]'>
                            <button className='bg-red-900 px-2 p'>Home</button>
                            <button className='bg-red-900 px-2 p'>Menu</button>
                            <button className='bg-red-900 px-2 p'>Deals</button>
                            <button className='bg-red-900 px-2 p'>Favourite</button>
                            <button className='bg-red-900 px-2 p'><img className='h-6 w-6' src="shopping-cart.png" alt="" /></button>
                        </div>
                </div>
