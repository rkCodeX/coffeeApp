           ...
           <div className='bg-[#d5d5d5] w-full h-auto flex flex-col gap-[2rem]'>
                <div className='flex flex-row justify-between items-center w-[full] px-[3rem]'>
                        ...
                        <div className='font-bold text-gray-800 flex flex-row justify-between items-center gap-[2rem]'>
                            <button className='bg-red-900 border-1 text-w px-2 py-1 '>Home</button>
                            <button className='bg-red-900 border-1 text-w px-2 py-1 '>Menu</button>
                            <button className='bg-red-900 border-1 text-w px-2 py-1 '>Deals</button>
                            <button className='bg-red-900 border-1 text-w px-2 py-1 '>Favourite</button>
                            <button className='bg-red-900 border-1 text-w px-2 py-1 '><img className='h-6 w-6' src="shopping-cart.png" alt="" /></button>
                        </div>
                </div>
