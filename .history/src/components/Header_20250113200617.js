           ...
           <div className='bg-[#d5d5d5] w-full h-auto flex flex-col'>
                ...
                <div className='flex flex-row w-full h-auto p-[4.5rem]'>
                    ...
                    <div className='relative flex-1 px-[3rem]'>
                        <div className='text-center text-[14rem] font-bold leading-none'>
                            COFFEE<br /> COFFEE<br /> COFFEE<br />
                        </div>
                        <img className='absolute w-[35rem] h-[35rem] top-[3.5rem] left-[12.5rem] z-10' src="coffee.png" alt="" />
                        ...
                        <img className='absolute right-[4rem] top-[28rem] z-0' src="beans.png" alt="" />
                    </div>
                </div>
           </div>
        </>
