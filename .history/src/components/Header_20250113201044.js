    ...
    return(
        <>
           <div className='bg-[#d5d5d5] w-full h-auto flex flex-col'>
                ...
                <div className='flex flex-row w-full h-auto p-[4.rem]'>

                    <div className='flex-1 whitespace-pre text-[4.5rem] leading-none'>
                    ...
                    <div className='relative flex-1 px-[3rem]'>
                        ...
                        <img className='absolute w-[37rem] h-[37rem] top-[4rem] left-[12rem] z-10' src="coffee.png" alt="" />
