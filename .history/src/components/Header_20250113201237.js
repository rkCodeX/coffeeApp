           ...
           <div className='bg-[#d5d5d5] w-full h-auto flex flex-col'>
                ...
                <div className='flex flex-row w-full h-auto p-[4rem]'>
                    ...
                    <div className='flex-1 whitespace-pre text-[4rem] leading-none'>
                         IT'S BREAK <br />WITH <span className='font-extrabold' > COFFEE <br />           COFFEE <br/>           COFFEE </span><br /><span className='text-[4.5rem]'>          COFFEE <br />          COFFEE <br />          COFFEE</span>
                    </div>

                    <div className='relative flex-1 px-[1.5rem'>
                        <div className='text-center text-[12rem] font-bold leading-none'>
                            COFFEE<br /> COFFEE<br /> COFFEE<br />
                        </div>
                        <img className='absolute w-[30rem] h-[30rem] top-[4rem] left-[12rem] z-10' src="coffee.png" alt="" />
                        <img className='absolute w-[20rem] h-[23rem] top-[18rem] left-[8.5rem] z-20' src="beansPack.png" alt="" />
                        <img className='absolute top-[28rem] left-[15rem] z-20' src="openBeans.png" alt="" />
