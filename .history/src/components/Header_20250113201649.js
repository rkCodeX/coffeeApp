           ...
           <div className='bg-[#d5d5d5] w-full h-auto flex flex-col'>
                ...
                <div className='flex flex-row w-full h-auto p-[4rem]'>
                    ...
                    <div className='relative flex-1'>
                        ...
                        <img className='absolute w-[23rem] h-[2rem] top-[4rem] left-[9rem] z-20' src="coffee.png" alt="" />
                        <img className='absolute w-[17rem] h-[15rem] top-[18rem] left-[8.5rem] z-20' src="beansPack.png" alt="" />
