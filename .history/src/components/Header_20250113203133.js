           ...
           <div className='bg-[#d5d5d5] w-full h-auto flex flex-col'>
                ...
                <div className='flex flex-row w-full h-auto p-[4rem]'>
                    ...
                    <div className='relative flex-1'>
                        ...
                        <img className='absolute w-[25rem] h-[25rem] top-[3.5rem] left-[7rem] z-20' src="coffee.png" alt="" />
                        ...
                        <img className='absolute w-[18rem] -right-[3rem] -top-[6rem] rotate-45 z-0' src="cookiesPack.png" alt="" />
                    </div>
                </div>
           </div>
        </>
