    ...
    return(
        <>
           <div className='bg-[#d5d5d5] w-full h-auto flex flex-col'>
                <div className='flex flex-row justify-between items-center w-[1] px-[3rem]'>
                ...
                <div className='flex flex-row w-full h-auto p-[2rem]'>
                    ...
                    <div className='relative flex-1'>
                        ...
                        <img className='absolute w-[26rem] h-[28rem] top-[2.5rem] left-[7rem] z-20' src="coffee.png" alt="" />
                        <img className='absolute w-[17rem] h-[16rem] top-[15rem] left-[2.5rem] z-30' src="beansPack.png" alt="" />
                        <img className='absolute w-[10rem] top-[22rem] left-[12.5rem] z-30' src="openBeans.png" alt="" />
                        <img className='absolute w-[15rem] right-[4rem] top-[20rem] z-0' src="beans.png" alt="" />
                        <img className='absolute w-[19rem] -right-[2rem] -top-[5rem] rotate-45 z-0' src="cookiesPack.png" alt="" />
                    </div>
                </div>
           </div>
        </>
