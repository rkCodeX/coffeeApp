           ...
           <div className='bg-[#d5d5d5] w-[100%] h-auto flex flex-col'>
                ...
                <div className='flex flex-row w-[100%] h-auto p-[2rem]'>
                    ...
                    <div className='relative flex-1'>
                        ...
                        <img className='absolute w-[17rem] h-[16rem] top-[15rem] left-[4rem] rotate-270 z-0' src="cookiesPack.png" alt="" />
                        <img className='absolute w-[10rem] top-[22rem] left-[12.5rem] z-30' src="openBeans.png" alt="" />
                        <img className='absolute w-[15rem] bottom-0 right-0 rotate-90 z-0' src="cookiesPack.png" alt="" />
                    </div>
                </div>
           </div>
        </>
