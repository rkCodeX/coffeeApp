           ...
           <div className='bg-[#d5d5d5] w-[100%] h-auto flex flex-col'>
                ...
                <div className='flex flex-row w-[100%] h-auto p-[2rem]'>
                    ...
                    <div className='relative flex-1'>
                        ...
                        <img className='absolute w-[24rem] h-[26rem] top-[2.5rem] left-[7.5rem] z-20' src="coffee.png" alt="" />
                        <img className='absolute w-[15rem] h-[14rem] top-[16rem] left-[2.5rem] z-30' src="beansPack.png" alt="" />
                        <img className='absolute w-[10rem] top-[20.5rem] left-[12.5rem] z-30' src="openBeans.png" alt="" />
                        <img className='absolute w-[16rem] -bottom-[2rem] right-0 z-0' src="cookiesPack.png" alt="" />
                    </div>
                </div>
           </div>
        </>
