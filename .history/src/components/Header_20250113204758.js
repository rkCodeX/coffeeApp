           ...
           <div className='bg-[#d5d5d5] w-[100%] h-auto flex flex-col'>
                ...
                <div className='flex flex-row w-[100%] h-auto p-[2rem]'>
                    ...
                    <div className='relative flex-1'>
                        ...
                        <img className='absolute w-[12rem] h-[10rem] top-[20rem] left-[2.5rem] z-30' src="beansPack.png" alt="" />
                        <img className='absolute w-[10rem] top-[20.5rem] left-[11rem] z-30' src="openBeans.png" alt="" />
