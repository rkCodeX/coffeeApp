           ...
           <div className='bg-[#d5d5d5] w-[100%] h-auto flex flex-col'>
                ...
                <div className='flex flex-row w-[100%] h-auto p-[2rem]'>
                    ...
                    <div className='relative flex-1'>
                        ...
                        <img className='absolute w-[5rem] top-[18.5rem] left-[5rem] z-20' src="coffee-bean.png" alt="" />
                        <img className='absolute w-[7rem] top-[18.5rem] left-[5rem] z-20' src="coffee-bean.png" alt="" />
                    </div>
                </div>
           </div>
        </>
