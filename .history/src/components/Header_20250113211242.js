           ...
           <div className='bg-[#d5d5d5] w-[100%] h-auto flex flex-col'>
                ...
                <div className='flex flex-row w-[100%] h-auto p-[2rem]'>
                    ...
                    <div className='relative flex-1'>
                        ...
                        <img className='absolute hover:rotate w-[7rem] top-[18.5rem] left-[5rem] z-20' src="beans.png" alt="" />
                        <img className='absolute hover:rotate w-[10rem] -top-[2rem] right-[7rem] z-10' src="coffee-beans.png" alt="" />
                        <img className='absolute hover:rotate w-[5rem] top-[1rem] left-[5rem] z-20' src="coffee-bean.png" alt="" />
                        <img className='absolute hover:rotate w-[4rem] top-[18.5rem] left-[0rem] rotate-45 z-20' src="coffee-bean.png" alt="" />
                        <img className='absolute hover:rotate w-[5rem] top-[20rem] right-[5rem] z-20' src="coffee-bean.png" alt="" />
                        <img className='absolute hover:rotate w-[4rem] top-[23rem] right-[9rem] z-20' src="coffee-bean.png" alt="" />
                    </div>
                </div>
           </div>
        </>
