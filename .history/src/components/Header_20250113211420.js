           ...
           <div className='bg-[#d5d5d5] w-[100%] h-auto flex flex-col'>
                ...
                <div className='flex flex-row w-[100%] h-auto p-[2rem]'>
                    ...
                    <div className='relative flex-1'>
                        ...
                        <img className='absolute hover:rotate-45 w-[24.5rem] top-[3.6rem] left-[7.5rem] z-20' src="coffee.png" alt="" />
                        <img className='absolute hover:rotate-45 w-[9rem] top-[20.5rem] left-[7.5rem] z-30' src="openBeans.png" alt="" />
