           ...
           <div className='bg-[#d5d5d5] w-[100%] h-auto flex flex-col'>
                ...
                <div className='flex flex-row w-[100%] h-auto p-[2rem]'>
                    ...
                    <div className='relative flex-1'>
                        ...
                        <img className='absolute hover:rotate-45 hover:w-[8rem] hover:top-[17.5] hover:left-[4rem] w-[7rem] top-[18.5rem] left-[5rem] z-20' src="beans.png" alt="" />
                        ...
                        <img className='absolute hover:rotate-90 w-[4rem] top-[23rem] right-[9rem] z-20' src="coffee-bean.png" alt="" />
                    </div>
                </div>
           </div>
        </>
