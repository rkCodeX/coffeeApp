           ...
           <div className='bg-[#d5d5d5] w-[100%] h-auto flex flex-col'>
                ...
                <div className='flex flex-row w-[100%] h-auto p-[2rem]'>
                    ...
                    <div className='relative flex-1'>
                        ...
                        <img className='absolute rotate-2 w-[15rem] -top-[2.5rem] left-[2.4rem] z-10' src="beans.png" alt="" />
                        <img className='absolute w-[10rem] -top-[1rem] right-[7rem] z-10' src="coffee-beans.png" alt="" />
