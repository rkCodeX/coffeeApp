           ...
           <div className='bg-[#d5d5d5] w-[100%] h-auto flex flex-col'>
                ...
                <div className='flex flex-row w-[100%] h-auto p-[2rem]'>
                    ...
                    <div className='relative flex-1'>
                        ...
                        <img className='absolute w-[11rem] top-[19rem] left-[7.5rem] z-20' src="openBeans.png" alt="" />
                        <img className='absolute -rotate-3 w-[15rem] -top-[2.5rem] left-[2.4rem] z-10' src="beans.png" alt="" />
                        <img className='absolute rotate-6 w-[10rem] -top-[2rem] right-[6rem] z-20' src="coffee-beans.png" alt="" />
