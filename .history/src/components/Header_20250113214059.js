           ...
           <div className='bg-[#d5d5d5] w-[100%] h-auto flex flex-col'>
                ...
                <div className='flex flex-row w-[100%] h-auto p-[2rem]'>
                    ...
                    <div className='relative flex-1'>
                        ...
                        <img className='absolute hover:w-[26rem] hover:top-[2.8rem] hover:left-[7rem] w-[25.5rem] top-[3.1rem] left-[7.rem] z-20' src="coffee.png" alt="" />
                        <img className='absolute w-[11.5rem] top-[19rem] left-[7.5rem] z-20' src="coffee-beans.png" alt="" />
