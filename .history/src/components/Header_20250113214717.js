           ...
           <div className='bg-[#d5d5d5] w-[100%] h-auto flex flex-col'>
                ...
                <div className='flex flex-row w-[100%] h-auto p-[2rem]'>
                    ...
                    <div className='relative flex-1'>
                        ...
                        <img className='absolute w-[6rem] -top-[0rem] right-[5rem] z-20' src="coffee-beans.png" alt="" />
                        ...
                        <img className='absolute w-[25rem] top-[15rem] right-[15rem] z-10' src="beans.png" alt="" />
                    </div>
                </div>
           </div>
        </>
