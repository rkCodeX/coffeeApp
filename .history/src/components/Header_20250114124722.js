           ...
           <div className='bg-[#d5d5d5] w-[100%] h-auto flex flex-col'>
                ...
                <div className='flex flex-row w-[100%] h-auto p-[2rem]'>
                    ...
                    <div className='relative flex-1'>
                        ...
                        <img className='absolute w-[26rem] top-[2.8rem] left-[7rem] z-30' src="coffee.png" alt="" />
                        <img className='absolute w-[10rem] top-[20rem] left-[7.5rem] z-30' src="beans.png" alt="" />
                        <img className='absolute -rotate-3 w-[6rem] top-[0rem] left-[6rem] z-20' src="cookie.png" alt="" />
                        <img className='absolute w-[10rem] -top-[1rem] right-[5rem] z-10' src="beans.png" alt="" />
                        <img className='absolute w-[4rem] top-[18.5rem] left-[0rem] rotate-180 z-20' src="cookie.png" alt="" />
                        <img className='absolute w-[5rem] top-[20rem] right-[0rem] z-20' src="cookie.png" alt="" />
                        <img className='absolute w-[4rem] top-[23.5rem] right-[4rem] z-20' src="cookie.png" alt="" />
                        <img className='absolute -rotate-90 w-[8rem] top-[2rem] -left-[5rem] z-10' src="cookies.png" alt="" />
                    </div>
                </div>
           </div>
        </>
