           ...
           <div className='bg-[#d5d5d5] w-[100%] h-auto flex flex-col'>
                ...
                <div className='flex flex-row w-[100%] h-auto p-[2rem]'>
                    ...
                    <div className='relative flex-1'>
                        ...
                        <img className='absolute -rotate-3 w-[6rem] top-[0rem] left-[6rem] z-20' src="coffee-bean.png" alt="" />
                        ...
                        <img className='absolute -rotate-90 w-[8rem] top-[2rem] -left-[5rem] z-10' src="coffee-bean.png" alt="" />
                    </div>
                </div>
           </div>
        </>
