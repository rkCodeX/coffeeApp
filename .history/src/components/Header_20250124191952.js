           ...
           <div className='bg-[#d5d5d5] w-[100%] h-auto pb-3 flex flex-col'>
                ...
                <div className='flex flex-row w-[100%] h-auto p-[2rem]'>
                    ...
                    <div className='flex-1 whitespace-pre max-[1066px]:text-[3rem] text-[4rem] leading-none'>
                         IT'S BREAK <br />WITH <span className='font-extrabold' > COFFEE <br />           COFFEE <br/>           COFFEE </span><br /><span className='text-[4.4rem]  max-[1066px]:text-[3.4rem]'>          COFFEE <br />          COFFEE <br />          COFFEE</span>
                    </div>
