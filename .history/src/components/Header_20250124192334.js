           ...
           <div className='bg-[#d5d5d5] w-[100%] h-auto pb-3 flex flex-col'>
                ...
                <div className='flex flex-row w-screen h-auto p-[2rem]'>
                    ...
                    <div className='relative flex-1'>
                        ...
                        <img className='absolute w-[26rem]  max-[1066px]:w-[18rem] top-[2.8rem] left-[7rem] z-30' src="coffee.png" alt="" />
                        <img className='absolute w-[10rem]   max-[1066px]:w-[18rem] top-[20rem] left-[7.5rem] z-30' src="coffee-bean.png" alt="" />
