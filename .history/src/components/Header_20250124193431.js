           ...
           <div className='bg-[#d5d5d5] w-[100%] h-auto pb-3 flex flex-col'>
                ...
                <div className='flex flex-row w-screen h-auto p-[2rem]'>
                    ...
                    <div className='relative flex-1'>
                        <div className='text-center   max-[774px]:text-[5rem]  text-[10rem] max-[1066px]:text-[7rem]  font-semibold leading-none'>
                        ...
                        <img className='absolute w-[10rem] max-[1066px]:top-[16rem]  max-[1066px]:w-[7rem] top-[20rem] left-[7.5rem] z-30' src="coffee-bean.png" alt="" />
                        <img className='absolute w-[18rem] max-[1066px]:right-[2rem] max-[1066px]:w-[10rem]  top-[13.5rem] right-[4rem] z-20' src="cookie.png" alt="" />
                        <img className='absolute rotate-90 max-[1066px]:right-[2rem] w-[4rem] top-[2rem] right-[7rem] z-10' src="bean.png" alt="" />
