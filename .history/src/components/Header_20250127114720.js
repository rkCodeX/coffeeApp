           ...
           <div className='bg-[#d5d5d5] w-[100%] h-auto pb-3 flex flex-col'>
                ...
                <div className='flex flex-row justify-between items-center w-[100%] px-[3rem]'>
                        ...
                        <div className='font-bold text-gray-800 flex flex-row justify-between items-center gap-[2rem]'>
                            ...
                            <button className='hover:bg-red-950 hover:text-gray-300 px-2 py-1'>Favorite</button>
                            <button><img className='h-6 w-6' src="shopping-cart.png" alt="" /></button>
                        </div>
                </div>

                <div className='flex flex-row max-[1106px]:flex-col justify-center items-center max-[1106px]:gap-[2rem] w-[100%] h-auto p-[2rem]'>
                    ...
                    <div className='relative flex-1'>
                        ...
                        <img className='absolute w-[26rem] top-[2.8rem] left-[7rem] z-30' src={`${process.env.PUBLIC_URL} /coffee.png`} alt="" />
                        ...
                        <img className='absolute -rotate-45 w-[6rem] top-[1rem] left-[5rem] z-10' src="coffee-beans.png" alt="" /> 
                    </div>
                </div>
