        ...
        <>
         <div className='flex flex-col items-center justify-evenly w-[100%] h-auto mt-[4rem]'>
            <div className='flex flex-row items-center justify-center'>
                <h1 className='relative px-[4rem] text-[1.2rem] font-extrabold border-r-2 border-black z-20'>COFFEE</h1>
                <img className='absolute w-[2rem] left-0 z-0' src="cafe.png" alt="" />
