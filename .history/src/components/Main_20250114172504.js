        ...
        <>
         <div className='flex flex-col items-center justify-evenly w-[100%] h-auto mt-[4rem]'>
            <div className='flex flex-row items-center justify-center'>
                <h1 className='relative px-[4rem] text-[1.2rem] font-extrabold border-r-2 border-black z-30'>
                    <h1 className='z-20'>COFFEE</h1>
                <img className='absolute w-[4rem] left-[2rem] -top-[1rem] z-10' src="cafe.png" alt="" />
                </h1>
