        ...
        <>
         <div className='flex flex-col items-center justify-evenly w-[100%] h-auto mt-[4rem]'>
            ...
            <div className='flex flex-row items-center justify-center'>
                ...
                <butt className='px-[4rem] text-[1.2rem] font-bold border-r-2 border-black'>ICE TEA</>
                <butt className='px-[4rem] text-[1.2rem] font-bold border-r-2 border-black'>BEVERAGE</>
                <butt className='px-[4rem] text-[1.2rem] font-bold border-black'>JUICES</>
            </div>
