         ...
         <div className='flex flex-col items-center justify-evenly w-[100%] h-auto mt-[4rem]'>
            ...
            <div className='w-[100%] flex flex-row items-center justify-evenly m-[4rem]'>
                ...
                <div className='flex-1/2'>
                    <div className='flex flex-col p-[4rem] w-auto h-auto'>
                        <h1>MILTON'S CHOCO COFFEE</h1>
                        <div>
                            <img src="rate.png" alt="" />
                            <h1>$12</h1>
                        </div>
                        <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Ea veniam accusantium laboriosam accusamus dolorem. Voluptatibus reiciendis cum accusamus, perspiciatis expedita itaque ad tenetur in temporibus dolorem eaque corrupti sit nobis.
                        Quod, aliquam? Molestias sed perspiciatis repellendus ab voluptate, dolorem voluptas, reprehenderit, alias quaerat aperiam quod ratione beatae amet libero? Ad reiciendis nobis aspernatur ratione eum provident tempore vel veniam molestias.</p>
                    </div>
                </div>
            </div>
