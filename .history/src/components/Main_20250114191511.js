         ...
         <div className='flex flex-col items-center justify-evenly w-[100%] h-auto mt-[4rem]'>
            ...
            <div className='w-[100%] flex flex-row items-center justify-evenly m-[4rem]'>
                <div className='flex-[50%] flex items-center justify-center'>
                    <div className='inline absolute w-[20rem] h-[20rem] border-black border-2 rounded-full'>
                        <img className='relative w-[6rem] -top-[2rem] left-[2rem]' src="coffee.png" alt="" />
                        <img className='relative w-[6rem] top-[2rem] -left-[3rem]' src="coffee.png" alt="" />
                        <img className='relative w-[6rem] top-[4rem] left-[3rem]' src="coffee.png" alt="" />
                        <img className='relative w-[6rem]' src="coffee.png" alt="" />
                    </div>  
                </div>
