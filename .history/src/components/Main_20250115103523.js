            ...
            <div className='w-[100%] flex flex-row items-center justify-evenly m-[4rem]'>
                <div className='flex-[50%] flex items-center justify-center'>
                    <div className='flex absolute w-[20rem] h-[20rem] border-black border-2 rounded-full'>
                        <img className ='relative w-[6rem] h-[4rem] -top-[2rem] left-[2.5rem]' src="coffee.png" alt="" />
                        <h1 className= 'relative text-lg -top-[2rem] left-[2.5rem]'>White </h1>
                        <img className ='relative w-[6rem] top-[6rem] -left-[10rem]' src="coffee.png" alt="" />
                        <img className ='relative w-[6rem] top-[15rem] -left-[10rem]' src="coffee.png" alt="" />
                        <img className ='relative w-[20rem] -top-[6rem] left-[10rem]' src="coffee.png" alt="" />
                    </div>  
                </div>
