...
function Coffee(){
    const title = ['Dark', 'Milk', 'White', 'Choco'];
    const [selected, setSelected] = useState(title[3]);
    const handleSelect = (e) => {
        setSelected(e.target.textConten);
    }
            ...
            <div className='w-[100%] flex flex-row items-center justify-evenly m-[4rem]'>
                <div className='flex-[50%] flex items-center justify-center'>
                    <div className='flex absolute w-[20rem] h-[20rem] border-black border-2 rounded-full'>
                        <img className ='relative w-[6rem] h-[6rem] -top-[2rem] left-[2.5rem]' src="coffee.png" onClick={handleSelect} alt="" />
                        <h1 className= 'relative text-lg top-[0rem] font-bold left-[3rem]'>{title[0]}</h1>
                        <img className ='relative w-[6rem] h-[6rem] top-[6rem] -left-[13rem]' src="coffee.png" alt="" />
                        <h1 className= 'relative text-lg top-[8rem] font-bold -left-[12rem]'>{title[1]}</h1>
                        <img className ='relative w-[6rem] h-[6rem] top-[15.5rem] -left-[15.5rem]' src="coffee.png" alt="" />
                        <h1 className= 'relative text-lg top-[18rem] font-bold -left-[15rem]'>{title[2]}</h1>
                ...
                <div className='flex-[50%]'>
                    <div className='flex flex-col p-[7rem] h-auto'>
                        <h1 className='text-2xl font-bold uppercase'>MILTON'S {title[3]} COFFEE</h1>
