...
function Content(){
    return(
        <>
            <div className='flex flex-col w-[100%] h-auto bg-[#d5d5d5]'>
                <div className='flex flex-row items-center justify-bet'>
                    <h1 className='text-lg '>The Best Taste <br /> From The Process</h1>
                    <h1></h1>
                </div>
