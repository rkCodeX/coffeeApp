        ...
        <>
            <div className='flex flex-col w-[100%] h-auto bg-[#d5d5d5] px-[5rem] py-[6rem]'>
                <div className='flex flex-row items-center justify-between'>
                    ...
                    <h1 className='w-[50%] text-just'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Voluptates repudiandae impedit vitae? Numquam aut fugiat praesentium, libero omnis a, commodi iusto ea officiis natus sequi est id odit, totam quae.</h1>
                </div>
