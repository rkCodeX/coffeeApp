    ...
    return(
        <>
            <div className='flex flex-col gap-[5rem] w-[100%] h-auto bg-[#d5d5d5] px-[5rem] py-[6rem]'>
                ...
                <div className='flex flex-row items-center justify-between'>
                    <div className='w-[29%] h-[14rem] rounded-[1.5rem] bg-red-95'></div>
                    <div className='w-[29%] h-[14rem] rounded-[1.5rem] bg-[#c99868]'></div>
                    <div className='w-[29%] h-[14rem] rounded-[1.5rem] bg-red-950'></div>
                </div>
            </div>
        </>
    );
