            ...
            <div className='flex flex-col gap-[5rem] w-[100%] h-auto bg-[#d5d5d5] px-[5rem] py-[6rem]'>
                ...
                <div className='flex flex-row items-center justify-between'>
                    <div className='flex flex-col items-center justify-center w-[29%] h-[14rem] rounded-[1.5rem] text-[#c99868] bg-[#35211e]'>
                        <h1 className='text-xlg font-bold'>Hand Roasted</h1>
                    </div>
                    <div className='flex flex-col items-center justify-center w-[29%] h-[14rem] rounded-[1.5rem] text-[#35211e] bg-[#c99868]'></div>
                    <div className='flex flex-col items-center justify-center w-[29%] h-[14rem] rounded-[1.5rem] text-[#c99868] bg-[#35211e]'></div>
                </div>
            </div>
        </>
    );
