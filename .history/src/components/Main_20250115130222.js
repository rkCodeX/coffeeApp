    ...
    return(
        <>
            <div className='flex flex-col gap-[5rem] w-[100%] h-auto bg-[#d5d5d5] px-[5rem] py-[6rem]'>
                ...
                <div className='flex flex-row items-center justify-between'>
                    <div className='flex flex-col items-center justify-center gap-[1.5re] w-[29%] h-[14rem] rounded-[1.5rem] text-[#c99868] bg-[#35211e]'>
                        <img className='w-[5rem] h-[5rem]' src="hands.png" alt="" />
