    ...
    return(
        <>
         <div className='flex flex-col items-center justify-evenly w-[100%] h-auto mt-[4rem]'>
            ...
            <div className='w-[100%] flex flex-row h-auto max-[918px]:flex-col items-center justify-evenly max-[918px]:m-0 max-[918px]:gap-[10rem] m-[4rem]'>
                <div className='flex-[50%] flex max-[918px]:mt-[10rem] items-center justify-center'>
