        ...
        <>
         <div className='flex flex-col items-center justify-evenly w-[100%] h-auto mt-[4rem]'>
            ...
            <div className='flex flex-row items-center justify-center'>
                ...
                <button className='px-[4rem] text-[1.2rem] max-[774px]:text-[1rem]  font-bold border-r-2 border-black'>ICE TEA</button>
                <button className='px-[4rem] text-[1.2rem] max-[774px]:text-[1rem]  font-bold border-r-2 border-black'>BEVERAGE</button>
                <button className='px-[4rem] text-[1.2rem] max-[774px]:text-[1rem]  font-bold border-black'>JUICES</button>
            </div>
