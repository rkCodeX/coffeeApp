        ...
        <>
         <div className='flex flex-col items-center justify-evenly w-[100%] h-auto mt-[4rem]'>
            ...
            <div className='flex flex-row items-center justify-center'>
                ...
                <button className='px-[4rem] text-[1.2rem] max-[774px]:text-[1rem] max-[918px]:px-[2] font-bold border-r-2 border-black'>ICE TEA</button>
                <button className='px-[4rem] text-[1.2rem] max-[774px]:text-[1rem] max-[918px]:px-[2] font-bold border-r-2 border-black'>BEVERAGE</button>
                <button className='px-[4rem] text-[1.2rem] max-[774px]:text-[1rem] max-[918px]:px-[2] font-bold border-black'>JUICES</button>
            </div>
    ...
    return(
        <>
            <div className='flex flex-col gap-[5rem] w-[100%] h-auto bg-[#d5d5d5] px-[5rem] py-[6rem]'>
                ...
                <div className='flex flex-row items-center justify-between'>
                    <div className='flex flex-col items-center justify-center gap-[1.5rem] w-[29%] h-[14rem] rounded-[1.5rem] text-[#c99868] bg-[#35211e]'>
                        <img className='w-[5.5rem] h-[5rem]' src="hands.png" alt="" />
                        <h1 className='text-xl font-bold'>Hand Roasted</h1>
                    </div>
                    <div className='flex flex-col items-center justify-center gap-[1.5rem] w-[29%] h-[14rem] rounded-[1.5rem] text-[#35211e] bg-[#c99868]'>
