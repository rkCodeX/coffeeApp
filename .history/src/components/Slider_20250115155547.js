            ...
            <div className='w-[100%] h-auto px-[4rem] py-[6rem]'>
                ...
                <div className='flex flex-row items-center justify-evenly w-[100%] h-[20rem]'>
                    <div>
                        ...
                        <div>
                            <p>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Unde libero saepe optio, nesciunt nemo, facilis possimus ipsa voluptas eligendi aperiam quis officiis maxime illo eum, accusantium deleniti voluptate error. Earum.</p>
                            <div>
                                <p></p>
                                <button></button>
                            </div>
