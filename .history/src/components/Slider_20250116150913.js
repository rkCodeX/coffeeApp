...
function Slider(){
    return(
        <>
            <div className='w-[100%] h-auto px-[4rem] py-[6rem] flex flex-col gap-[1rem]'>
                <h1 className='w-[100%] text-center font-extrabold text-4xl mb-[1rem]'>OUR POPULAR FLAVOUR</h1>
