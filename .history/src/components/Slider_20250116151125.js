...
function Slider(){
    return(
        <>
            <div className='w-[100%] h-auto px-[4rem] py-[6rem] flex flex-col'>
                <h1 className='w-[100%] text-center font-extrabold text-4xl mb-[2rem]'>OUR POPULAR FLAVOUR</h1>
                ...
                <div className='flex flex-row items-center justify-center w-[100%] h-auto'>
                    <button className='w-[0.8rem] h-[0.8rem] ml-1 rounded-full bg-red-950 border-red-950 border-2'></button>
                    <button className='w-[0.8rem] h-[0.8rem] ml-1 rounded-full bg-red-950 border-red-950 border-2'></button>
                    <button className='w-[0.8rem] h-[0.8rem] ml-1 rounded-full bg-red-950 border-red-950 border-2'></button>
                    <button className='w-[0.8rem] h-[0.8rem] ml-1 rounded-full bg-red-950 border-red-950 border-2'></button>
                </div>
